...
var UserController = /** @class */ (function (_super) {
    ...
    UserController.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_model_1.UserSchemaModel.find({}).lean()];
                    case 1:
                        dd = _a.sent();
                        return [2 /*return*/, dd];
                }
    ...
    UserController.prototype.doctor = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dd;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserController.prototype.patient = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var reqBody, user, salt, _a, userModel, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        salt = _b.sent();
                        _a = user;
                        return [4 /*yield*/, (0, bcrypt_1.hash)(reqBody.password || 'Demo@123', salt)];
                    case 2:
                        _a.passwordHash = _b.sent();
                        user.email = reqBody.email;
                        user.mobile = reqBody.mobile;
                        return [4 /*yield*/, user_model_1.UserSchemaModel.create(user)];
                    case 3:
                        userModel = _b.sent();
